...
LikhonFlix API is a powerful service that provides streaming links for movies and series using IMDB IDs. It supports multiple languages, including Hindi, English, Tamil, Telugu, and Bengali.

## Features

- **Streaming Links**: Get streaming links for movies and series using their IMDB IDs.
- **Multiple Languages**: Supports Hindi, English, Tamil, Telugu, and Bengali.

## Documentation

### Get Media Info

Provides information file and key which is used to get stream link.
...
**Try**: [Try it](https://likhonflix-api.vercel.app/api/v1/mediaInfo?id=tt1877830)
...
**Try**: [Try it](https://likhonflix-api.vercel.app/api/v1/getSeasonList?id=tt11737520)
...
|------|-------------|----------|
| file | Get it from mediaInfo | True |
| key  | Get it from mediaInfo | True |
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/likhonsheikh54/likhonflix-api.git
   ```
...
1. **Build the Docker image**:
   ```bash
   docker build -t likhonflix-api .
   ```

2. **Run the Docker container**:
   ```bash
   docker run -p 3000:3000 -it -d likhonflix-api
   ```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Flikhonsheikh54%2Flikhonflix-api)

**Note**: Vercel's free tier serverless response time limit is 10 seconds and will stop if it takes longer.

### Render

[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/likhonsheikh54/likhonflix-api)
